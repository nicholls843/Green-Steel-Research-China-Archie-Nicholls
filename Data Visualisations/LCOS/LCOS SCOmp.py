...
# --- Shared settings ---
# fig.suptitle("Levelised Cost of Green Steel — Scenario Comparison by City (small multiples by year)", fontsize=16)
for ax in axes[2:]:
    ax.set_xlabel("USD per tonne of steel", fontsize=12)
...
plt.savefig(r"C:\Users\archi\Data Visualisations\LCOS\LCOS_Scenario_Dumbbells_byYear.png", dpi=300)
plt.show()
